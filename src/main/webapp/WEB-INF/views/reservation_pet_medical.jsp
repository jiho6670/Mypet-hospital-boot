    ...
    <main class="main-container">
        <div class="reservation-form-container">
            ...
            <section class="reservation-section">
                ...
                <div class="notice-box">
                    ...
                    <ul>
                        ...
                        <li>예약을 신청하신 후 24시간 이후(평일 기준)에 확정일자를 확인하셔야 합니다.</li>
                        <li>진료를 받지 못하실 경우, 미리 예약변경/취소를 해 주세요.</li>
                        <li>진료당일 변경 및 취소는 반드시 고객센터로 연락 바랍니다.</li>
                    </ul>
            ...
            <section class="reservation-section">
                ...
                <form action="<c:url value='/reservation/medical/create'/>" method="post" class="info-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="memo" name="memo" rows="5" placeholder="아이의 증상 및 요청사항을 작성해주세요."></textarea>
                    </div>
